	...
	<section class="about-section text-center" id="about">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p class="text-white-50 mx-auto mt-2 mb-5">Alice of wonder always seem to be in a hurry. We created this app to help her find her path 
				through snary Malmö and get away from the evil queen.</p>
